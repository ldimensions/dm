...
<div class="mcontainer">
    <div class="maincontainer">
        <div class="leftcontainer">
            <div class="paggination"><a href="{{ URL::to('/') }}/{{config('app.defaultBaseURL.dallas-indian-grocery-store')}}" class="subcontent2 h21">Groceries</a>&nbsp;&nbsp;>&nbsp;&nbsp;<span class="title">{{ $grocery['name'] }}</span></div>
            <div class="block2">
                <div class="gro_title toparea space">
                    <table class="fullWidth">
                        ...
                        @endif
                        {!!CommonController::share($grocery['name'])!!}
                    </table> 
                </div>
                <div class="content">
                    <table class="fullWidth">
                            ...
                            @if($wtKey == "default")
                                <table>
                                    ...
                                    @foreach ($wtArr[0] as $wtArrKey => $wtRs)
                                        ...
                                        <tr>
                                            @if ( $wtArrKey == $today )
                                                <td class="activeweekdays daysWith">{{CommonController::getDaysShort($wtArrKey)}}</td>
                                            @else
            ...
            <div class="white_t1 space">
                ...
                <a href="https://www.google.com/maps/dir//{{ $grocery['name'] }} {{ $grocery['address1'] }} {{ $grocery['address2'] }}, {{ $grocery['city'] }}, {{ $grocery['state'] }}, {{ $grocery['zip'] }}/%40{{$grocery['latitude']}},{{$grocery['longitude']}},12z" title="{{ $grocery['name'] }}" target="_blank" class="mapicon12"><img src="{{ URL::to('/') }}/image/map1.svg" alt="{{ $grocery['name'] }}"/></a>
                </div>
