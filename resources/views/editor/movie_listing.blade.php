...
@section('content')
                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li><a href="{{ url('/editor/movie_add') }}">Add</a>
                                    </li>                                   
                                </ul>
                            </div>
                        </div>
                                ...
                                <tbody>
                                    @foreach ($movies_pending as $key => $rel)
                                        ...
                                        @endif    
                                                ...
                                                <td width="65px;">
                                                    <a href="{{ url('/editor/movie_add') }}/{{$rel['movieId']}}"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></button></a>
                                ...
                                <tbody>
                                    @foreach ($movies as $key => $rel)
                                        ...
                                        @endif    
                                                ...
                                                <td width="65px;">
                                                    @if (!$rel['referenceId'])
                                                        <a href="{{ url('/editor/movie_add_duplicate') }}/{{$rel['movieId']}}"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></button></a>
                                                    @endif
                                                </td>
                                            </tr>
                                    @endforeach
  ...
  <script>
    ...
    function deleteMovie(id) {
        ...
        if (r == true) {
            window.location.href = "/editor/movie/delete/"+id;
        }
    }      
    </script> 
@endsection
