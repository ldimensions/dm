        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="panel-body">   
                            @if($religion['status'] == 4) 
                                <div class="alert alert-danger" style="white-space: pre-wrap;">{{$religion['statusMsg']}}</div><br/>                               
                            @endif                                                                
                            <form name="religion" action="{{ url('/editor/religion_add') }}" method="POST" role="form" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="text" name="ref_id" value="{{ $religion['ref_id'] }}" id="ref_id">
                                <input type="text" name="id" value="{{ $religion['id'] }}" id="id">
                                <input type="text" name="addressId" value="{{ $religion['addressId'] }}" id="addressId">
                                <input type="text" name="urlId" value="{{ $religion['urlId'] }}" id="urlId">
                                <input type="text" name="seoId" value="{{ $religion['seoId'] }}" id="seoId">  
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="religion" style="position: relative;min-height: 680px;">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <label>Order</label>
                                                <input type="number" min="0" step="1" name="order" value="{{ old('order', $religion['order']) }}" id="order" maxlength="15" class="form-control">
                                            </div>                                 
                                            <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="meta" style="position: relative;min-height: 520px;">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input name="SEOMetaTitle" value="{{ old('SEOMetaTitle', $religion['SEOMetaTitle']) }}" id="SEOMetaTitle" maxlength="70" class="form-control">
                                            </div> 
                                            <div class="form-group">
                                                ...
                                                @foreach ($photos as $key => $photo)
                                                    @if($photo['is_primary'] == 1)
                                                        <div class="smallImage">
                                                            <img src="{{ URL::to('/') }}/image/religion/{{$religion['id']}}_tmp/{{$photo['photoName']}}"  style="width:100px;height:100px">
                                                        </div>
                                                    @endif
                                                @endforeach
                                            </div> 
                                ...
                                <div style="position:relative;widht:100%">                                  
                                    ...
                                    <a href="{{ url('/editor/religion') }}"><button type="button" class="btn btn-default">Cancel</button></a>                                                              
                                </div>
                            </form>
                        </div>
                    </div>
