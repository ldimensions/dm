        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="panel-body">                                          
                            <form name="event" action="{{ url('/editor/events_category_add') }}" method="POST" role="form" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div style="position:relative;widht:100%">                                  
                                    ...
                                    <a href="{{ url('/editor/events_category') }}"><button type="button" class="btn btn-default">Cancel</button></a>                                                              
                                </div>
                            </form>
                        </div>
                    </div>
