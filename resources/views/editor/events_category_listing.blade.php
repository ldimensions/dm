...
@section('content')
                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li><a href="{{ url('/editor/events_category_add') }}">Add</a>
                                    </li>                                   
                                </ul>
                            </div>
                        </div>
                          ...
                          <tbody>
                            @foreach ($category as $key => $rel)
                                ...
                                @endif    
                                        <td>{{$rel['name']}}</td>
                                        <td width="75px;">
                                            <a href="{{ url('/editor/events_category_add') }}/{{$rel['id']}}"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></button></a>
  ...
  <script>
    ...
    function deleteCategory(id) {
        ...
        if (r == true) {
            window.location.href = "/editor/events_category/delete/"+id;
        }
    }      
    </script> 
@endsection
