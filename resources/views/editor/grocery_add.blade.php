            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="panel-body">  
                        @if($grocery['status'] == 4) 
                            <div class="alert alert-danger" style="white-space: pre-wrap;">{{$grocery['statusMsg']}}</div><br/>                               
                         @endif                             
                         <form name="grocery" action="{{ url('/editor/grocery_add') }}" method="POST" role="form" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="hidden" name="ref_id" value="{{ $grocery['ref_id'] }}" id="ref_id">
                                ...
                                <div style="position:relative;widht:100%">                                  
                                    ...
                                    <a href="{{ url('/editor/grocery') }}"><button type="button" class="btn btn-default">Cancel</button></a>                                                              
                                </div>
                            </form>
                        </div>
                    </div>
