            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="panel-body"> 
                            @if($event['status'] == 4) 
                                <div class="alert alert-danger" style="white-space: pre-wrap;">{{$event['statusMsg']}}</div><br/>                               
                            @endif                                                                   
                            <form name="event" action="{{ url('/editor/events_add') }}" method="POST" role="form" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <input type="hidden" name="ref_id" value="{{ $event['ref_id'] }}" id="ref_id">
                                <input type="hidden" name="temp_id" value="{{ $event['temp_id'] }}" id="temp_id">
                                                ...
                                                @foreach ($photos as $key => $photo)
                                                    @if($photo['is_primary'] == 1)
                                                        <div class="smallImage">
                                                            ...
                                                            @else
                                                                <img src="{{ URL::to('/') }}/image/event/{{$event['id']}}_tmp/{{$photo['photoName']}}"  style="width:100px;height:100px">
                                                            @endif
                                                        </div>
                                                    @endif
                                                @endforeach
                                                ...
                                                <div class="form-group">
                                                    <div>Layout</div>
                                                        <div class="smallImage" style="float:left;padding:10px;">
                                                            ...
                                                            @else
                                                                <img src="{{ URL::to('/') }}/image/event/{{$event['id']}}_tmp/{{$event['img']}}"  style="width:100px;height:100px">
                                                            @endif                                                            
                                                        </div>                                                    
                                                </div>  
                                            @endif                                                                                                                                       
                                ...
                                <div class="col-lg-10" style="position:relative;widht:100%">                                  
                                    ...
                                    <a href="{{ url('/editor/events') }}"><button type="button" class="btn btn-default">Cancel</button></a>                                                              
                                </div>
                            </form>
                        </div>
                    </div>
