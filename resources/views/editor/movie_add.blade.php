            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="panel-body"> 
                            @if($movie['status'] == 4) 
                                <div class="alert alert-danger" style="white-space: pre-wrap;">{{$movie['statusMsg']}}</div><br/>                               
                            @endif                                                                        
                            <form name="movie" action="{{ url('/editor/movie_add') }}" method="POST" role="form" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                <input type="hidden" name="id" value="{{ $movie['id'] }}" id="id">
                                <input type="hidden" name="temp_id" value="{{ $movie['temp_id'] }}" id="temp_id">
                                <input type="hidden" name="urlId" value="{{ $movie['urlId'] }}" id="urlId">
                                <input type="hidden" name="seoId" value="{{ $movie['seoId'] }}" id="urlId">  
                                <input type="hidden" name="ref_id" value="{{ $movie['ref_id'] }}" id="ref_id">
                                ...
                                <div style="position:relative;widht:100%">                                  
                                    ...
                                    <a href="{{ url('/editor/movies') }}"><button type="button" class="btn btn-default">Cancel</button></a>                                                              
                                </div>
                            </form>
                        </div>
                    </div>
