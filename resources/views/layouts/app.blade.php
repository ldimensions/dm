...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <!-- Scripts -->
        <script src="{{ asset('js/app.js') }}?version=6.6" defer></script>
        ...
        <link href="{{ asset('css/style.css') }}?version=6.6" rel="stylesheet">
        <link href="{{ asset('css/lightslider.css') }}?version=6.6" rel="stylesheet">
