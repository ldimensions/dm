...
<html lang="{{ app()->getLocale() }}">
    <head>
        ...
        <!-- Scripts -->
        <script src="{{ asset('js/app.js') }}?version=6.5" defer></script>
        ...
        <link href="{{ asset('css/style.css') }}?version=6.5" rel="stylesheet">
        <link href="{{ asset('css/lightslider.css') }}?version=6.5" rel="stylesheet">
