                ...
                <div class="panel panel-default">  
                        ...
                        <div class="pull-right">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu pull-right" role="menu">
                                    <li><a href="{{ url('/admin/grocery_add') }}">Add</a>
                                    </li>                                   
                                </ul>
                            </div>
                        </div>
                  ...
                  <div class="panel-body">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#pending" data-toggle="tab">Pending ({{count($grocery_pending)}})</a> </li>                        
                        </ul>   
                                    ...
                                    <tbody>
                                        @foreach ($grocery as $key => $rel)
                                            ...
                                            @endif    
                                                    ...
                                                    <td width="170px;">{{ $rel['ethnicName'] }}</td>
                                    ...
                                    <tbody>
                                        @foreach ($grocery_pending as $key => $rel)
                                            ...
                                            @endif   
                                                    ...
                                                    <td width="150px;">{{ $rel['updatedBy'] }}</td>                                                    
                                                    <td width="150px;">
                                                        <button type="button" class="btn btn-default btn-sm" onClick="deleteTempGrocery({{$rel['groceryId']}})"><i class="fa fa-trash-o"></i></button>
                                                        <button type="button" class="btn btn-default btn-sm" onClick="approveGrocery({{$rel['groceryId']}})"><i class="fa fa-thumbs-up"></i></button>
                                                        <button data-toggle="modal" data-target="#myModal" data-val="{{$rel['groceryId']}}"  data-whatever="@mdo" class="btn btn-default btn-sm"><i class="fa fa-thumbs-down"></i></button>                                                    
                                                    </td>
                                                </tr>
                                        @endforeach
                                    </tbody>
  ...
  <script>
    $(document).ready(function() {
        ...
        $("#suggessionBtn").click(function(e) {
            ...
            if(reason.length && id){
                $.ajax({
                    url: "/admin/grocery/rejectGrocery",
                    type: "POST",
                    headers: {
    ...
    function deleteTempGrocery(id) {
        ...
        var r = confirm("Are you sure to delete");
        if (r == true) {
            window.location.href = "/admin/grocery_tmp/delete/"+id;
        }
    }    
    function approveGrocery(id){
        var r = confirm("Are you sure to approve");
        if (r == true) {
            window.location.href = "/admin/grocery/approve/"+id;
        }
    }          
    </script> 
@endsection
