                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="grocery" style="position: relative;min-height: 600px;">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="form-group">
                                                <label>Order</label>
                                                <input name="order" value="{{ old('order', $grocery['order']) }}" id="order" maxlength="15" class="form-control">
                                            </div>                                 
                                            <div class="form-group">
                                    ...
                                    <div class="tab-pane fade" id="meta" style="position: relative;min-height: 520px;">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input name="SEOMetaTitle" value="{{ old('SEOMetaTitle', $grocery['SEOMetaTitle']) }}" id="SEOMetaTitle" maxlength="20" class="form-control">
                                            </div> 
                                            <div class="form-group">
