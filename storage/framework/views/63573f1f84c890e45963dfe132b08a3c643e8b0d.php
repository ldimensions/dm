...
<div class="maincontainer">
        ...
        <div class="col-md-12 searchbar hiddepadding"> <a href="#" class="selocation"></a>
            <form>
                ...
                <select name="type" class="select" id="type">
                    <option 
                        value="<?php echo e(config('app.defaultBaseURL.dallas-indian-grocery-store')); ?>-2" 
                        <?php echo e(config('app.defaultBaseURL.dallas-indian-grocery-store').'-2' == $type ? 'selected="selected"' : ''); ?>>
                            All
                    </option>
                    <option 
                        value="<?php echo e(config('app.defaultBaseURL.dallas-indian-grocery-store')); ?>-2"
                    ...
                    <option 
                        value="<?php echo e(config('app.defaultBaseURL.dallas-kerala-grocery-store')); ?>-1"
                        <?php echo e(config('app.defaultBaseURL.dallas-kerala-grocery-store').'-1' == $type ? 'selected="selected"' : ''); ?>>
                            Kerala
                    </option>
                    <option 
                        value="<?php echo e(config('app.defaultBaseURL.dallas-tamil-grocery-store')); ?>-3"
                        <?php echo e(config('app.defaultBaseURL.dallas-tamil-grocery-store').'-3' == $type ? 'selected="selected"' : ''); ?>>
                            Tamil
                    </option>
                </select>
        ...
        <?php $__currentLoopData = $grocery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-md-12 block1">
                    ...
                    <?php if(isset($rel['photoName']) && $rel['photoName']): ?>
                        <img src="<?php echo e(URL::to('/')); ?>/image/grocery/<?php echo e($rel['id']); ?>/<?php echo e($rel['photoName']); ?>" alt="<?php echo e($loop->index); ?><?php echo e($rel['name']); ?>" style="width:100%;height:100%"></div>
                    <?php else: ?>   
                        <img src="<?php echo e(URL::to('/')); ?>/image/noimage.svg" alt="<?php echo e($loop->index); ?><?php echo e($rel['name']); ?>" style="width:100%;height:100%"></div>
                    <?php endif; ?>                  
                    <a href="<?php echo e(URL::to('/')); ?>/<?php echo e(config('app.defaultBaseURL.grocery-store-details')); ?>/<?php echo e($rel['urlName']); ?>" title="<?php echo e($rel['name']); ?>" ><h2 class="content1 colorh1"><?php echo e($rel['name']); ?></h2></a>                                                      
                    ...
                    <?php if(isset($rel['distance']) && $rel['distance']): ?>
                        <div class="gro_kmblock_list"><?php echo e($rel['distance']); ?></div>
                    <?php endif; ?>                 
    ...
    <script>
        function grocerySearch() {
            ...
            var urlParm     =   '';
            if(city && city != 'all'){
                if(type == "<?php echo e(config('app.defaultBaseURL.dallas-indian-grocery-store')); ?>-2"){
                    city        =   "<?php echo e(config('app.defaultBaseURL.indian-grocery-store-in')); ?>"+city;
                }else if(type == "<?php echo e(config('app.defaultBaseURL.dallas-kerala-grocery-store')); ?>-1"){
                    city        =   "<?php echo e(config('app.defaultBaseURL.kerala-grocery-store-in')); ?>"+city;
                }else if(type == "<?php echo e(config('app.defaultBaseURL.dallas-tamil-grocery-store')); ?>-3"){
                    city        =   "<?php echo e(config('app.defaultBaseURL.tamil-grocery-in')); ?>"+city;
                }else{
                    city        =   'all';
                }
            }else{
            ...
            urlParm = "<?php echo e(URL::to('/')); ?>/<?php echo e(config('app.defaultBaseURL.grocery-search')); ?>/"+type+"/"+city+"/"+keyword;
