                    ...
                    <div class="pull-right">
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu pull-right" role="menu">
                                <li><a href="<?php echo e(url('/admin/restaurant_add')); ?>">Add</a>
                                </li>                                   
                            </ul>
                        </div>
                    </div>
                          ...
                          <tbody>
                            <?php $__currentLoopData = $restaurant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $rel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <?php endif; ?>    
                                        ...
                                        <td class="ceter">
                                            <a href="<?php echo e(URL::to('/')); ?>/<?php echo e(config('app.defaultBaseURL.dallas-indian-restaurant')); ?>/<?php echo e($rel['urlName']); ?>" target="_blank" class="title">Link</a>    
                                        </td>
                                        <td width="75px;">
                                            <a href="<?php echo e(url('/admin/restaurant_add')); ?>/<?php echo e($rel['restaurantId']); ?>"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-edit"></i></button></a>
                                            <button type="button" class="btn btn-default btn-sm" onClick="deleteRestaurant(<?php echo e($rel['restaurantId']); ?>)"><i class="fa fa-trash-o"></i></button>
                                        </td>                                         
                                    </tr>
